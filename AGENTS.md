...
Review pull requests with the reviewer charter in [`.github/skills/cli-code-reviewer/SKILL.md`](.github/skills/cli-code-reviewer/SKILL.md): understand the linked issue and prior decisions first, then report findings as requirement, nit, or commentary.
